...
const GradientBackgroundCardComponent = () => {
  return (
    <div className="flex my-5  gap-6">
      <div className="relative group py-6 px-6 rounded-3xl border w-full my-4 shadow-xl hover:bg-gradient-to-r from-purple-200 to-pink-200">
        {/* Top Icon */}
        ...
        {/* Card Body */}
        <div className="mt-8">
          <p className="text-xl font-semibold my-2 group-hover:text-slate-800">App Development</p>
          <div className="flex space-x-2 text-gray-400 text-sm">
            ...
            <p className="group-hover:text-slate-800">Marketing Team</p>
          </div>
...
export { GradientBackgroundCardComponent };
